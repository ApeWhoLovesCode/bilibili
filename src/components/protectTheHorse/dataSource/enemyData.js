...
export default [
  ...
  {name: '舞王小兵', x: 0, y: 15, w: 75, h: 75, curFloorI: 0,  curSpeed: 2, speed: 2, reward: 10, hp: {cur: 10, sum: 10, size: 8},       audioKey: 'pvz', type: 'gif', imgSource: require("../assets/img/zombies/zombies_10_move.gif"), imgList: [], imgIndex: 0},
