 ...
 */
export default [
  {name: '茄子',     money: 500, saleMoney: 250, r: 300, damage: 5, targetNum: 1, rate: 1100, speed: 12, bSize: {w:20,h:20}, audioKey: 'qizi-wujie', img: require("../assets/img/plant/qiezi.png"), bulletImg: require("../assets/img/plant/bullet3.png")},
  {name: 'PDD',      money: 600, saleMoney: 300, r: 200, damage: 3, targetNum: 20, rate: 3000, speed: 8, bSize: {w:20,h:20},   audioKey: 'pdd-heihei', img: require("../assets/img/plant/pdd.png"), bulletImg: require("../assets/img/plant/flame.png")},
