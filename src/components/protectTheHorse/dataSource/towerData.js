...
export default [
  ...
  {name: '茄子',     money: 500, saleMoney: 250, r: 300, damage: 6, targetNum: 1, rate: 1200, speed: 2, bSize: {w:20,h:20}, audioKey: 'qizi-wujie', img: require("../assets/img/plant/qiezi.png"), bulletImg: require("../assets/img/plant/bullet3.png")},
