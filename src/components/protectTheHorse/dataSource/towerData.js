...
export default [
  ...
  {name: 'PDD',      money: 500, saleMoney: 150, r: 200, damage: 3, targetNum: 20, rate: 3000, speed: 8, bSize: {w:20,h:20},   audioKey: 'pdd-heihei', img: require("../assets/img/plant/pdd.png"), bulletImg: require("../assets/img/plant/flame.png")},
