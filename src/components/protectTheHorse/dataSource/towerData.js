...
export default [
  ...
  {name: 'PDD',      money: 600, saleMoney: 300, r: 200, damage: 4, targetNum: 20, rate: 3000, speed: 8, bSize: {w:20,h:20},   audioKey: 'pdd-heihei', img: require("../assets/img/plant/pdd.png"), bulletImg: require("../assets/img/plant/flame.png")},
